...
now = datetime.now()
now = now.strftime("%Y")
project = "xxxpython_package_namexxx"
...
if True or (runAutodoc2 and runAutodoc2 != "None"):
    ...
    autodoc2_packages = [
        {
            "path": "../../xxxpython_package_namexxx",
...
# OpenGraph metadata
ogp_site_url = "https://xxxpython_package_namexxx.readthedocs.io/en"
...
html_title = f"xxxpython_package_namexxx <small>v{__version__}</small>"
