...
setup(name="xxxpython_package_namexxx",
      ...
      url='https://github.com/thespacedoctor/xxxpython_package_namexxx',
      download_url='https://github.com/thespacedoctor/xxxpython_package_namexxx/archive/v%(__version__)s.zip' % locals(
      ),
